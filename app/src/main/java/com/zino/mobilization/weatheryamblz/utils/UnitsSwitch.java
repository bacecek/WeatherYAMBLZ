...
public class UnitsSwitch extends FrameLayout {
    ...
    public UnitsSwitch(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        txtTitle.setText(title != null ? title : context.getString(R.string.switch_default_title));
        String leftValue = a.getString(R.styleable.UnitsSwitch_textLeft);
        txtLeft.setText(leftValue != null ? leftValue : context.getString(R.string.switch_default_left_value));
        String rightValue = a.getString(R.styleable.UnitsSwitch_textRight);
        txtRight.setText(rightValue != null ? rightValue : context.getString(R.string.switch_default_right_value));
