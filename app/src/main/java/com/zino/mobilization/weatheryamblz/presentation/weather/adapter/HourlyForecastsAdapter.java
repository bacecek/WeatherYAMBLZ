...
import com.zino.mobilization.weatheryamblz.presentation.weather.diffutils.HourlyForecastsDiffCallback;
...
public class HourlyForecastsAdapter extends RecyclerView.Adapter<HourlyForecastsAdapter.ViewHolder> {
    ...
    public void updateData(List<HourlyForecast> newData) {
        ...
        final HourlyForecastsDiffCallback diffCallback = new HourlyForecastsDiffCallback(this.data, newData);
